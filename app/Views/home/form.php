<form id="accordion">
    ...
    <div class="list-group">
        ...
        <!-- Step 3 -->
        <div class="list-group-item py-3" data-acc-step>
            <h5 class="mb-0" data-acc-title>Language</h5>
            <div data-acc-content>
                <div class="my-3">
                    <div class="form-group">
                        <label>Currently, templates are available in english, french, german, spanish, ukrainian and polish. Please select yours:</label>
                        <select name="language" class="form-control">
                            <option value="en">english</option>
                            <option value="fr">french</option>
                            <option value="de">german</option>
                            <option value="de">spanish</option>
                            <option value="de">ukrainian</option>
